...
This event is named `VectorChanged` for all languages, but for C# the implemented collection type is [IList&lt;T>](/dotnet/api/system.collections.generic.ilist-1).
