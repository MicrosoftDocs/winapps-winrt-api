...
Adds the `TimeSpan` component of two [Duration](duration.md) values. C# code should use the [Addition](/dotnet/api/windows.ui.xaml.duration.op_addition) (+) operator or the [Duration.Add](/dotnet/api/windows.ui.xaml.duration.add) method instead.
