...
Returns whether the `TimeSpan` component of a given [Duration](duration.md) holds a non-null value. C# code should use [Duration.HasTimeSpan](/dotnet/api/windows.ui.xaml.duration.hastimespan) instead.
