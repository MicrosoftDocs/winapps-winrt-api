...
## -remarks
To establish a value for `Path`, create a new [PropertyPath](propertypath.md) using the [PropertyPath(String)](propertypath_propertypath_290278668.md) constructor.
