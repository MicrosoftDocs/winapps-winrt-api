...
If you implement custom gesture detection to initiate a drag operation, you can call the [Microsoft.UI.Xaml.UIElement.StartDragAsync](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.uielement.startdragasync(microsoft.ui.input.pointerpoint)) method to programmatically initiate a drag operation on any UIElement. Calling this method results in the [Microsoft.UI.Xaml.UIElement.DragStarting](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.uielement.dragstarting) event being raised. Handle the DragStarting event to specify other properties of the operation, such as the data package and drag visual.
