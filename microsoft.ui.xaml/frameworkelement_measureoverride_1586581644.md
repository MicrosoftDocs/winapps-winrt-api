---
-api-id: M:Microsoft.UI.Xaml.FrameworkElement.MeasureOverride(Windows.Foundation.Size)
...
# Microsoft.UI.Xaml.FrameworkElement.MeasureOverride
...
+ For each child, calls [Measure](uielement_measure_1722732750.md), using a [Size](/uwp/api/windows.foundation.size) that makes sense based on how the panel logic treats the number of children and its own known size limit.
