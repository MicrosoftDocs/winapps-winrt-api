...
> [!NOTE]
> Calling the [FrameworkElement.SetBinding](../microsoft.ui.xaml/frameworkelement_setbinding_632680108.md) method and passing in a new Binding object won't necessarily remove an existing binding. Instead, you should use the [Microsoft.UI.Xaml.DependencyObject.ClearValue](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.dependencyobject.clearvalue) method.
