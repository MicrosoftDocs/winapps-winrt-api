...
+ For C++, this parameter passes a [TypeName](/uwp/api/windows.ui.xaml.interop.typename) structure value. `TypeName::Kind` contains the simple string name of the type, similar to Microsoft .NET's `Type.Name`.
