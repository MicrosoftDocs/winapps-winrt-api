---
-api-id: T:Microsoft.UI.Composition.Interactions.InteractionChainingMode
-api-type: winrt enum
---
...
:::image type="content" source="images/chainingmode.png" alt-text="A diagram showing a VisualInteractionSource (B) that is the child of another VisualInteractionSource (A).":::
