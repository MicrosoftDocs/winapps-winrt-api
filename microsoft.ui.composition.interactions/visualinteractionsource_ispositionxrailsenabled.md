...
:::image type="content" source="images/rails.png" alt-text="Diagram showing how pans within 22.5 degrees of the horizontal axis will get recognized as perfect horizontal pans – in other words, their X components will be ignored. If outside the threshold of 22.5 degrees of the axis, then the X component will then be recognized.":::
