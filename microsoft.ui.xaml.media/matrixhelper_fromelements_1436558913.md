...
## -description
Creates a new [Matrix](matrix.md) based on provided initial [Matrix](matrix.md) data values. C# code should use [Matrix](/dotnet/api/system.windows.media.matrix.-ctor?view=dotnet-uwp-10.0) constructor instead.
