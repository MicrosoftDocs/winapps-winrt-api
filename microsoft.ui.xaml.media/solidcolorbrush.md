...
## -see-also
[Color](/uwp/api/windows.ui.color), [Colors](../microsoft.ui/colors.md), [Brush](brush.md), [Color.FromArgb](/dotnet/api/windows.ui.color.fromargb?view=dotnet-uwp-10.0&preserve-view=true), [XAML brushes](/windows/apps/design/style/brushes), [ResourceDictionary and XAML resource references](/windows/apps/design/style/xaml-resource-dictionary)
