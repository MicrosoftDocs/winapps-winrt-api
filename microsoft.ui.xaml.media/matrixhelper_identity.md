...
## -description
Gets a static constructed [Matrix](matrix.md) where the values established are representative of an **Identity** transform. C# code should use [Identity](/dotnet/api/system.windows.media.matrix.identity?view=dotnet-uwp-10.0) instead.
