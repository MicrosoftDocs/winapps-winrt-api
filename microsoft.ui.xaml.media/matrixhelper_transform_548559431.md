...
## -description
Transforms a provided [Matrix](matrix.md) using a [Point](/uwp/api/windows.foundation.point) input, and returns a [Point](/uwp/api/windows.foundation.point) result. C# code should use [Transform](/dotnet/api/system.windows.media.matrix.transform?view=dotnet-uwp-10.0) instead.
