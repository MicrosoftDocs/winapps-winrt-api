...
The unique identifier for the app notification group to be removed, accessed with the [Group](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.appnotification.group) property.
