...
To ensure that the **NotificationInvoked** event handler is called within the process of the running app, be sure to register the handler for this event before calling [Register](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications/appnotificationmanager_register_292201929). Otherwise, a new process will be launched to handle the invocation.

## -see-also

[Register](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications/appnotificationmanager_register_292201929)
