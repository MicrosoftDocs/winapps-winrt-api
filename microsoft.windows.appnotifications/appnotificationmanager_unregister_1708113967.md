...
Unregisters the app from receiving [NotificationInvoked](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.appnotificationmanager.notificationinvoked) events when the user interacts with an app notification.
...
Register to receive **NotificationInvoked** events by calling [Register](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.appnotificationmanager.register).
