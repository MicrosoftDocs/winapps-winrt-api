...
The unique identifier for the set of notifications to be removed, accessed with the [Tag](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.appnotification.tag) property.
