...
## -examples
Here's how to use the [ApiInformation.IsMethodPresent](/uwp/api/windows.foundation.metadata.apiinformation.ismethodpresent) to check for the presence of the Stop method before you call it.
