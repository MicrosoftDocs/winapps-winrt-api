---
-api-id: M:Microsoft.UI.Xaml.Media.Imaging.RenderTargetBitmap.RenderAsync(Microsoft.UI.Xaml.UIElement,System.Int32,System.Int32)
...
## -description
Renders a snapshot of a [UIElement](../microsoft.ui.xaml/uielement.md) visual tree to an image source. Specify values for *scaledWidth* and *scaledHeight* to alter the original source's rendering dimension.
...
If you need a pixel buffer representation of the rendered content and not just an image source, use [GetPixelsAsync](rendertargetbitmap_getpixelsasync_1480284075.md) after calling [RenderAsync](rendertargetbitmap_renderasync_318933921.md).
...
Calling [RenderAsync](rendertargetbitmap_renderasync_318933921.md) will fail if the scaled height or width of the [UIElement](../microsoft.ui.xaml/uielement.md) visual tree are larger than the amount of video memory the system is able to allocate internally.
...
You can call this method and leave the *scaledWidth* and *scaledHeight* values both as 0. In this case the [UIElement](../microsoft.ui.xaml/uielement.md) tree will be rendered at its native size. This is the same behavior as the [RenderAsync(UIElement)](rendertargetbitmap_renderasync_318933921.md) overload.
...
## -see-also
[RenderAsync(UIElement)](rendertargetbitmap_renderasync_318933921.md), [XAML render to bitmap sample](https://github.com/microsoftarchive/msdn-code-gallery-microsoft/tree/master/Official%20Windows%20Platform%20Sample/XAML%20render%20to%20bitmap%20sample)
