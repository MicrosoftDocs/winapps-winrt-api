...
Requests that an announcement be shown in the taskbar. The feeds host may or may not show this announcement, based on its policies. If the user interacts with the announcement, the feed provider's [OnAnnouncementInvoked](/windows/windows-app-sdk/api/winrt/microsoft.windows.widgets.feeds.providers.ifeedannouncementinvokedtarget.onannouncementinvoked) method will be called.
