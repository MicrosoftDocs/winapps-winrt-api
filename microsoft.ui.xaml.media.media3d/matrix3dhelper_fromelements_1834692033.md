...
## -description
Defines a new [Matrix3D](matrix3d.md) value, using element values for each of the possible values of a [Matrix3D](matrix3d.md) structure. C# code should use [Matrix3D](/dotnet/api/system.windows.media.media3d.matrix3d.-ctor?view=dotnet-uwp-10.0) constructor instead.
