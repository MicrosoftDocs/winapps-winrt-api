...
## -description
Gets a static constructed [Matrix3D](matrix3d.md) where the values established are representative of an **Identity** transform. C# code should use [Identity](/dotnet/api/system.windows.media.media3d.matrix3d.identity?view=dotnet-uwp-10.0) instead.
