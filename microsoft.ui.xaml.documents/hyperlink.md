...
Use the [Click](hyperlink_click.md) event for actions other than launching a Uniform Resource Identifier (URI) in a browser, such as navigation within the app. For example, if you want to load a new app page rather than opening a browser, call a [Frame.Navigate](../microsoft.ui.xaml.controls/frame_navigate_1557370995.md) method within your [Click](hyperlink_click.md) event handler to navigate to the new app page. If you want an external, absolute Uniform Resource Identifier (URI) to load within a [WebView2](../microsoft.ui.xaml.controls/webview2.md) control that also exists in your app, call [WebView2.NavigateToString(System.String)](../microsoft.ui.xaml.controls/webview2_navigatetostring_1924125949.md) as part of your [Click](hyperlink_click.md) handler logic.
