---
-api-id: T:Microsoft.UI.Xaml.Documents.Block
...
In the Windows Runtime XAML vocabulary the only block type is [Paragraph](paragraph.md). You use [Paragraph](paragraph.md) to define the blocks of text to display within a [RichTextBlock](../microsoft.ui.xaml.controls/richtextblock.md) control. Every [RichTextBlock](../microsoft.ui.xaml.controls/richtextblock.md) should include at least one [Paragraph](paragraph.md).

[BlockCollection](blockcollection.md) is a strongly typed collection class that is used by the [RichTextBlock.Blocks](../microsoft.ui.xaml.controls/richtextblock_blocks.md) property. By specifying XAML object elements within a [RichTextBlock](../microsoft.ui.xaml.controls/richtextblock.md), you can assign the block text content for the [RichTextBlock](../microsoft.ui.xaml.controls/richtextblock.md). This is usually done using an implicit collection and XAML property syntax, such that the [Paragraph](paragraph.md) elements appear as direct children of [RichTextBlock](../microsoft.ui.xaml.controls/richtextblock.md) in XAML markup. For example:
```xaml
<RichTextBlock>
...
## -see-also
[TextElement](textelement.md), [Paragraph](paragraph.md), [RichTextBlock](../microsoft.ui.xaml.controls/richtextblock.md)
