---
-api-id: P:Microsoft.UI.Xaml.Controls.Primitives.GridViewItemPresenter.DragBackground
...
## -xaml-values
<dl><dt>themeResourceReference</dt><dd>themeResourceReferenceA ThemeResource markup extension reference to an existing keyed resource that defines a Brush-type resource in a XAML resource dictionary. For example, to reference a resource with the key GridViewItemDragBackgroundThemeBrush, the string is {ThemeResource GridViewItemDragBackgroundThemeBrush}.</dd>
</dl>
## -property-value
