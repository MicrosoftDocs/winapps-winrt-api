---
-api-id: P:Microsoft.UI.Xaml.Controls.Primitives.GridViewItemPresenter.PointerOverBackground
-api-type: winrt property
---

<!-- Property syntax
public Windows.UI.Xaml.Media.Brush PointerOverBackground { get;  set; }
-->
...
## -xaml-values
<dl><dt>themeResourceReference</dt><dd>themeResourceReferenceA ThemeResource markup extension reference to an existing keyed resource that defines a Brush-type resource in a XAML resource dictionary. For example, to reference a resource with the key GridViewItemPointerOverBackgroundThemeBrush, the string is {ThemeResource GridViewItemPointerOverBackgroundThemeBrush}.</dd>
</dl>
## -property-value
