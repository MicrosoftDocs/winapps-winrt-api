...
If you are using a Microsoft .NET language (C#), then GeneratorPosition has non-data members available, and its data members are exposed as read-write properties, not fields.
