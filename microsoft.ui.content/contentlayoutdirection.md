...
Specifies the supported layout direction for reading order and text alignment of a [ContentSite](/windows/windows-app-sdk/api/winrt/microsoft.ui.content.contentsite).
