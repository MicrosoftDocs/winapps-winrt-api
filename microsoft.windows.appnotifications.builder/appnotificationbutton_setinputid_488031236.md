...
You can also set the input ID of an app notification button with the [AppNotificationButton.InputId](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder.appnotificationbutton.inputid).
