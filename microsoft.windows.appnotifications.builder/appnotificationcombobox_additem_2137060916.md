...
You can also set the items for an app notification combo box with the [AppNotificationComboBox.Items](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder/appnotificationcombobox_items) property.
