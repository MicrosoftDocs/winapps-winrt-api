...
You can also set the context menu placement value with the [AppNotificationButton.ContextMenuPlacement](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder/appnotificationbutton_contextmenuplacement) property.
