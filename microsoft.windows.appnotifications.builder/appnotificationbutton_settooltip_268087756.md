...
You can also set the tool-tip text by using the [AppNotificationButton.ToolTip](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder/appnotificationbutton_tooltip) property.

Tool-tip text is only supported for on Windows 10 Build 19041 and later. Call [AppNotificationButton.IsToolTipSupported](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder/appnotificationbutton_istooltipsupported_198402885) to determine at runtime if tool-tips are supported on the current device.
