...
You should set either the [InvokeUri](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder/appnotificationbutton_invokeuri) or the **TargetAppId**, but not both. If you do set both, the system will use the **TargetAppId**.
