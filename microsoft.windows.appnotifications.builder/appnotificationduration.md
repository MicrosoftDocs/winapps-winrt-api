...
Set the duration for an app notification by calling [AppNotificationBuilder.SetDuration](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder.appnotificationbuilder.setduration)).
