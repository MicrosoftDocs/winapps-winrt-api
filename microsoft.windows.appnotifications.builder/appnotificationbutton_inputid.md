...
You can also set the input ID of an app notification button by calling [AppNotificationButton.SetInputId](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder.appnotificationbutton.setinputid)).
