...
You can also set the title with the [AppNotificationComboBox.Title](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder.appnotificationcombobox.title) property.
