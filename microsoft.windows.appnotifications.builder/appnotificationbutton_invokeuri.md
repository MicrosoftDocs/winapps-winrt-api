...
You should set either the invoke URI or the [TargetAppId](/windows/windows-app-sdk/api/winrt/microsoft.windows.appnotifications.builder/appnotificationbutton_targetappid), but not both. If you do set both, the system will use the **TargetAppId**.
