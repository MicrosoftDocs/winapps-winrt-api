...
Occurs when an object is registered as a drop target for the [DragDropManager](/windows/windows-app-sdk/api/winrt/microsoft.ui.input.dragdrop/dragdropmanager).
