...
This is the default value for the <ref:Microsoft.Windows.Widgets.Providers.WidgetUpdateRequestOptions.CustomState>, [Data](/windows/windows-app-sdk/api/winrt/microsoft.windows.widgets.providers/widgetupdaterequestoptions_data), and [Template](/windows/windows-app-sdk/api/winrt/microsoft.windows.widgets.providers/widgetupdaterequestoptions_template) properties. If you don't set any value on these properties, they will be treated as unset. Set the properties to empty string to clear the previously set value.
