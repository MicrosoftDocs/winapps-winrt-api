...
Note that when a widget is first created, as indicated by a call to [WidgetContext)](/windows/windows-app-sdk/api/winrt/microsoft.windows.widgets.providers.iwidgetprovider.createwidget(microsoft.windows.widgets.providers.widgetcontext)), it is in the active state.
