---
-api-id: M:Microsoft.UI.Xaml.Markup.XamlReader.Load(System.String)
...
## -examples
This example creates a single [Ellipse](../microsoft.ui.xaml.shapes/ellipse.md) from a XAML string, calling Load. Then it connects the created but disconnected [Ellipse](../microsoft.ui.xaml.shapes/ellipse.md) to the [Children](../microsoft.ui.xaml.controls/panel_children.md) collection of an element that already existed in the running UWP app. Finally the example accesses the [Ellipse](../microsoft.ui.xaml.shapes/ellipse.md) again in the location where it was added by using a query, and changes one of its properties.
