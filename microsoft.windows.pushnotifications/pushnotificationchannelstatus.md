...
The push channel creation request is in progress and is in a backoff retry state. Check the [PushNotificationCreateChannelResult.ExtendedError](/windows/windows-app-sdk/api/winrt/microsoft.windows.pushnotifications/pushnotificationcreatechannelresult_extendederror) property to get the last extended error seen when creating a channel request.
