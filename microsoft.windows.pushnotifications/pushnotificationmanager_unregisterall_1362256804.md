...
Cleans up all registration-related data for push notifications. After this, push notifications for the app will not function until [Register](/windows/windows-app-sdk/api/winrt/microsoft.windows.pushnotifications/pushnotificationmanager_register_292201929) is called again.
...
Calling **UnregisterAll* is not a common scenario. In most cases, apps should use [Unregister](/windows/windows-app-sdk/api/winrt/microsoft.windows.pushnotifications/pushnotificationmanager_register_292201929).
