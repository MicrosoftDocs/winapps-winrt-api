...
Gets the payload of the push notification that triggered the associated [PushReceived](/windows/windows-app-sdk/api/winrt/microsoft.windows.pushnotifications/pushnotificationmanager_pushreceived) event.
