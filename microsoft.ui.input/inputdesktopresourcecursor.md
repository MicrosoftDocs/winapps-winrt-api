...
Uses a resource ID. If you need to use a string resource name instead, see [InputDesktopNamedResourceCursor](/windows/windows-app-sdk/api/winrt/microsoft.ui.input.inputdesktopnamedresourcecursor) (Visual Studio assigns a unique integer ID to new resources).
