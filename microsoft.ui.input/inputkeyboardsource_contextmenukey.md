...
Occurs when the **Menu** virtual-key (or Shift + F10) is unhandled from a previous [KeyDown](/windows/windows-app-sdk/api/winrt/microsoft.ui.input/inputkeyboardsource_keydown) event.
