...
Contains event data for the [InputActivationChanged](/windows/windows-app-sdk/api/winrt/microsoft.ui.input.inputactivationlistener.inputactivationchanged) event.
