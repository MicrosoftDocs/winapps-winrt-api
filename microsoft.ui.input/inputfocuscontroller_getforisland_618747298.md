...
Retrieves an [InputFocusController](/windows/windows-app-sdk/api/winrt/microsoft.ui.input.inputfocuscontroller) object for the specified [ContentIsland](../microsoft.ui.content/contentisland.md).
...
The [InputFocusController](/windows/windows-app-sdk/api/winrt/microsoft.ui.input.inputfocuscontroller) object for the specified [ContentIsland](../microsoft.ui.content/contentisland.md), or a new InputFocusController if one doesn't exist.
...
In all cases there can only be a single [InputFocusController](/windows/windows-app-sdk/api/winrt/microsoft.ui.input.inputfocuscontroller) associated with a particular content island.
