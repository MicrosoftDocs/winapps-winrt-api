...
## -description
Returns whether a specified [RepeatBehavior](repeatbehavior.md) has a **RepeatBehaviorType** of **Count** and a nonzero **Count** value. C# code should use [HasCount](/dotnet/api/system.windows.media.animation.repeatbehavior.hascount?view=dotnet-uwp-10.0&preserve-view=true) instead.
