...
## -description
Returns whether a specified [RepeatBehavior](repeatbehavior.md) has a **RepeatBehaviorType** of **Duration** and a nonzero **Duration** value. C# code should use [HasDuration](/dotnet/api/system.windows.media.animation.repeatbehavior.hasduration?view=dotnet-uwp-10.0&preserve-view=true) instead.
