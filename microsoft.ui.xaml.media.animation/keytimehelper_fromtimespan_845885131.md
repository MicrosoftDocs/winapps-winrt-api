...
## -description
Generates a new [KeyTime](keytime.md) with initial data based on the specified [TimeSpan](/uwp/api/windows.foundation.timespan). C# code should use [FromTimeSpan](/dotnet/api/windows.ui.xaml.media.animation.keytime.fromtimespan?view=dotnet-uwp-10.0&preserve-view=true) instead.
