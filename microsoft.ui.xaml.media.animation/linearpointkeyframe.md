---
-api-id: T:Microsoft.UI.Xaml.Media.Animation.LinearPointKeyFrame
...
## -description
Animates from the [Point](/uwp/api/windows.foundation.point) value of the previous key frame to its own [Value](pointkeyframe_value.md), using linear interpolation.
