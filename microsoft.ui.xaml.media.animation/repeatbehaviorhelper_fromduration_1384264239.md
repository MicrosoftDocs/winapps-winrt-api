...
## -description
Creates a new [RepeatBehavior](repeatbehavior.md) based on a timespan. C# code should use [RepeatBehavior(TimeSpan)](/dotnet/api/system.windows.media.animation.repeatbehavior.-ctor?view=dotnet-uwp-10.0&preserve-view=true#system-windows-media-animation-repeatbehavior-ctor(system-double)) instead.
