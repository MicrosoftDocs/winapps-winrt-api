---
-api-id: T:Microsoft.UI.Xaml.Media.Animation.LinearColorKeyFrame
...
## -description
Animates from the [Color](/uwp/api/windows.ui.color) value of the previous key frame to its own [Value](colorkeyframe_value.md) using linear interpolation.
