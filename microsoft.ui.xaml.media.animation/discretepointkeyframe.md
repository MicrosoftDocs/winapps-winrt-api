---
-api-id: T:Microsoft.UI.Xaml.Media.Animation.DiscretePointKeyFrame
...
## -description
Animates from the [Point](/uwp/api/windows.foundation.point) value of the previous key frame to its own [Value](pointkeyframe_value.md) using discrete frames.
...
## -see-also
[Storyboarded animations](/windows/apps/design/motion/storyboarded-animations), [PointKeyFrame](pointkeyframe.md), [PointAnimationUsingKeyFrames](pointanimationusingkeyframes.md), [KeyTime](pointkeyframe_keytime.md), [Value](pointkeyframe_value.md), [KeyTime](pointkeyframe_keytime.md), [Value](pointkeyframe_value.md)
