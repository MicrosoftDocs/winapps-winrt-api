...
You can set the property on the `AnimatedIcon` or on an ancestor in the XAML tree. In either case, you need to use the attached property syntax: `<AnimatedIcon AnimatedIcon.State="Normal">...</AnimatedIcon>`.
