...
If you are programming using C#, see [RemoveAt](/uwp/api/windows.ui.xaml.controls.uielementcollection.removeat). The behavior of each language's **RemoveAt** is basically the same.
