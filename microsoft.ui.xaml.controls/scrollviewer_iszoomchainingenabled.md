...
The ScrollViewer's chaining properties ([**IsHorizontalScrollChainingEnabled**](scrollviewer_ishorizontalscrollchainingenabled.md), [**IsVerticalScrollChainingEnabled**](scrollviewer_isverticalscrollchainingenabled.md), **IsZoomChainingEnabled**) do not apply when the control is in inertial mode. Because mouse wheel rotations are handled as **inertial manipulations**, chaining does not work.
