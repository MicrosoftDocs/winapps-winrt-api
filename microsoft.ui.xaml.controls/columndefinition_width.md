...
## -see-also
[Grid](grid.md), [Grid.ColumnDefinitions](grid_columndefinitions.md), [Grid.Column](grid_column.md), [Define layouts with XAML](/windows/uwp/layout/layouts-with-xaml)
