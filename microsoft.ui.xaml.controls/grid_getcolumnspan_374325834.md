...
## -description
Gets the value of the [Grid.ColumnSpan](grid_columnspan.md) XAML attached property from the specified [FrameworkElement](../microsoft.ui.xaml/frameworkelement.md).
