---
-api-id: T:Microsoft.UI.Composition.CompositionAnimationGroup
...
Use the [CompositionObject.StartAnimationGroup](compositionobject_startanimationgroup_1756471033.md) and [CompositionObject.StopAnimationGroup](compositionobject_stopanimationgroup_1347139553.md) methods to start and stop the animation group.
...
## -see-also
[CompositionObject](compositionobject.md), [IClosable](/uwp/api/windows.foundation.iclosable), [IIterable(CompositionAnimation)](/uwp/api/windows.foundation.collections.iiterable-1), [ICompositionAnimationBase](icompositionanimationbase.md)
