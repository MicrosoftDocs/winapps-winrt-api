...
The intersection of supported languages declared by the app (see [ManifestLanguages](applicationlanguages_manifestlanguages.md)) and the list of languages for which the user has declared a preference (the user profile language list). If this intersection is empty, the app's default language.
